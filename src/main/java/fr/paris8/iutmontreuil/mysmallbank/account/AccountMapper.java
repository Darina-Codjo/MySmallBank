...
public class AccountMapper {
    ...
    public static List<AccountDTO> toDTOs(List<Account> accounts) {
        return accounts.stream().map(AccountMapper::toHolderDTO).collect(Collectors.toList());
    }

    public static List<Account> toAccounts(List<AccountEntity> accounts) {
        return accounts.stream().map(AccountMapper::toAccount).collect(Collectors.toList());
    }
    ...
    public static List<Account> toAccount(List<AccountDTO> accountDTO) {
        return accountDTO.stream().map(AccountMapper::toAccount).collect(Collectors.toList());
    }
